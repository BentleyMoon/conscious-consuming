...
window.OVS_LENS = {
  meta: {
    ...
    slug: 'messages',
    proof: {
      title: 'One component, another domain',
      text: 'This page, Kosplora, and Conscious Consuming call the same decision.js recipes, controls, explanations, and math. Only the list and the skin change.',
      links: [
        { href: '../../instances/', label: 'See every instance' },
        { href: '../../standard/', label: 'Read the standard' }
      ]
    },
  ...
  // The decision contract. Same component Conscious Consuming and Kosplora drive; only the
  // configuration differs, which is the whole claim this instance exists to demonstrate.
  decision: {
    category:'messages', status:'illustrative', headline:'Choose where to send it',
    reads:{
      text:'Messengers differ most in what they keep about you, how they encrypt, whether anyone can audit them, how easy they are, and who you can actually reach.',
      basis:[
        {criterion:'privacy',readsAs:'what they keep'},
        {criterion:'security',readsAs:'encryption'},
        {criterion:'openness',readsAs:'auditability'},
        {criterion:'ease',readsAs:'ease'},
        {criterion:'reach',readsAs:'who you reach'}
      ]
    },
    axes:[
      // One axis, not three, and the reason is measured rather than stylistic. Signal leads on
      // four of the five criteria here, so a dial only tilts weight BETWEEN its two criteria
      // while every other criterion keeps its baseline weight. Spread across three axes, one
      // move was diluted below the margin Signal holds, and the answer never changed at any
      // setting of any dial: three sliders that did nothing. Two axes still could not move it.
      // A single axis carries enough weight to flip the recommendation at 60 and above, so this
      // dial is the only one on this list that a person moving it can actually feel.
      {id:'privacy-or-reach',kind:'tradeoff',label:'Privacy or reach',question:'Keep more to yourself, or reach more people?',criteria:['privacy','reach'],poles:['More private','Where people already are'],default:50}
    ],
    budget:{available:false,mode:'unavailable',criterion:null,knownEntries:0},
    archetypes:['best-for-most','strictest-match'],
    floor:{
      id:'floor:messages-illustrative-v1',version:'1.0.0',label:'Illustrative messaging floor',
      reads:'No release-grade exclusion rule exists for this short illustrative list, so the floor folds nothing and every option stays visible.',
      rules:[]
    }
  },
  resources: [
    ...
    {code:'imessage', name:'iMessage', brand:'Apple',
     ...
     provenance:{privacy:'Apple; less ad-driven, some metadata',security:'E2EE between Apple users',openness:'Closed, Apple-only',ease:'Built into every Apple device',reach:'Huge on iPhone; no Android'}},
